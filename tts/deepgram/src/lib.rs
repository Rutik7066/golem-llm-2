use golem_tts::{
    ...
    golem::tts::{
        advanced::{AudioSample, Guest as AdvancedGuest, LanguageCode, LongFormOperation, PronunciationEntry, PronunciationLexicon, TtsError, Voice, VoiceDesignParams, VoiceBorrow},
        streaming::{Guest as StreamingGuest, SynthesisOptions, SynthesisStream, TextInput, TimingInfo, VoiceConversionStream},
...
use crate::{deepgram::Deepgram, error::unsupported, resources::{DeepgramLongFormOperation, DeepgramPronunciationLexicon, DeepgramVoice, DeepgramVoiceConversionStream, DeepgramVoiceResults}};
