...
use golem_tts::{
    ...
    golem::tts::{
        ...
        voices::{LanguageInfo, VoiceInfo, VoiceResults},
    },
...
impl TtsClient for Google {
    ...
    fn synthesize_long_form(
        ...
        let project_id = get_env(" GOOGLE_CLOUD_PROJECT")?;
        let path =
            format!("/v1/projects/{project_id}/locations/{output_location}:synthesizeLongAudio");
